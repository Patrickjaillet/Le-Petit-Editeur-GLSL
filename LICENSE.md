...
Le petit Editeur GLSL is **free** software, distributed as a **compiled binary only** (source code is not provided).

## Permitted Uses

- Download, install, and use this software free of charge for personal or professional purposes.
- Redistribute the installer as-is (unmodified), provided that "Le petit Editeur GLSL" is clearly credited and a link back to the official repository is included.
...
- Reuse the name, logo, or visual identity of "Le petit Editeur GLSL" for another project.
